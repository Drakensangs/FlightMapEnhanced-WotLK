...
if (GetLocale() == "koKR") then
    ...
    FLIGHTMAP_OPT_SHOW_ZONE_TOOLTIP         = "구역 툴팁 표시";
    ...
    FLIGHTMAP_OPT_MAX_TOOLTIP_LINES_TIP     = "구역 툴팁에 표시되는 최대 줄 수";
    FLIGHTMAP_OPT_SHOW_FM_CONTINENT         = "항공사 대륙 아이콘";
    FLIGHTMAP_OPT_SHOW_FM_CONTINENT_TIP     = "대륙 지도에 항공편사 아이콘을 표시합니다.";
    FLIGHTMAP_OPT_SHOW_FM_CLASS             = "클래스별 항공편사 아이콘";
    FLIGHTMAP_OPT_SHOW_FM_CLASS_TIP         = "클래스별 항공편사 아이콘을 표시합니다.";
    FLIGHTMAP_OPT_SHOW_FM_TOOLTIP           = "항공사 툴팁";
    FLIGHTMAP_OPT_SHOW_FM_TOOLTIP_TIP       = "항공사 아이콘 위에 마우스를 올리면 항공편 정보가 포함된 툴팁을 표시합니다.";
