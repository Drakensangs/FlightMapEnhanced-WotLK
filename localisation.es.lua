...
if (GetLocale() == "esES") then
    ...
    FLIGHTMAP_OPT_MAX_TOOLTIP_LINES_TIP     = "Número máximo de líneas que se muestran en la información sobre herramientas de la zona.";
    FLIGHTMAP_OPT_SHOW_FM_CONTINENT         = "Iconos de continentes del maestro de vuelo";
    FLIGHTMAP_OPT_SHOW_FM_CONTINENT_TIP     = "Mostrar iconos del maestro de vuelo en el mapa de continentes.";
    FLIGHTMAP_OPT_SHOW_FM_CLASS             = "Iconos del maestro de vuelo específicos de la clase";
    FLIGHTMAP_OPT_SHOW_FM_CLASS_TIP         = "Mostrar iconos del maestro de vuelo específicos de la clase.";
    FLIGHTMAP_OPT_SHOW_FM_TOOLTIP           = "Información sobre herramientas del maestro de vuelo";
    FLIGHTMAP_OPT_SHOW_FM_TOOLTIP_TIP       = "Mostrar una información sobre herramientas con información de vuelo al pasar el cursor sobre un icono del maestro de vuelo.";
