...
FLIGHTMAP_OPT_SHOW_ZONE_TOOLTIP         = "顯示區域工具提示";
FLIGHTMAP_OPT_SHOW_ZONE_TOOLTIP_TIP     = "在世界地圖左下角顯示懸停區域的飛行資訊。";
FLIGHTMAP_OPT_SHOW_ZONE_LEVELS          = "顯示區域空域範圍";
FLIGHTMAP_OPT_SHOW_ZONE_LEVELS_TIP      = "在區域工具提示中顯示每個區域的建議空域範圍。";
FLIGHTMAP_OPT_AWESOME_SEPARATOR         = "awesome_wotlk:";
FLIGHTMAP_OPT_NOTIFY_TASKBAR            = "通知：工作列圖標";
FLIGHTMAP_OPT_TOOLTIP_FONT_SIZE         = "工具提示字體大小";
FLIGHTMAP_OPT_TOOLTIP_FONT_SIZE_TIP     = "調整區域工具提示的字體大小。";
FLIGHTMAP_OPT_MAX_TOOLTIP_LINES         = "工具提示最大行數";
FLIGHTMAP_OPT_MAX_TOOLTIP_LINES_TIP     = "區域工具提示中顯示的最大線條數。";
FLIGHTMAP_OPT_SHOW_FM_CONTINENT         = "飛行大師洲際圖示。";
FLIGHTMAP_OPT_SHOW_FM_CONTINENT_TIP     = "在洲際地圖上顯示飛行大師圖示。";
FLIGHTMAP_OPT_SHOW_FM_CLASS             = "特定類別的飛行大師圖示。";
FLIGHTMAP_OPT_SHOW_FM_CLASS_TIP         = "顯示特定類別的飛行大師圖示。";
FLIGHTMAP_OPT_SHOW_FM_TOOLTIP           = "飛行大師工具提示。";
FLIGHTMAP_OPT_SHOW_FM_TOOLTIP_TIP       = "當滑鼠懸停在飛行大師圖示上時，顯示包含飛行資訊的工具提示。";
